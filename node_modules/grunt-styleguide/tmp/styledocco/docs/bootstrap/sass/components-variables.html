...
<h2 id="component-variables"> COMPONENT VARIABLES</h2>
<h2 id="zindex-master-list"> Z-index master list</h2>
<p> Used for a bird&#39;s eye view of components dependent on the z-axis
 Try to avoid customizing these :)</p>
<h2 id="sprite-icons-path"> Sprite icons path</h2>
<h2 id="input-placeholder-text-color"> Input placeholder text color</h2>
<h2 id="hr-border-color"> Hr border color</h2>
...
<p> Special enhancement for popovers</p>
<h2 id="grid"> GRID</h2>
<h2 id="default-940px-grid"> Default 940px grid</h2>
<p> 1200px min</p>
<p> 768px-979px</p>
<h2 id="fluid-grid"> Fluid grid</h2>
<p> 1200px min</p>
<p> 768px-979px</p>
</div><div class="code"><pre><code>$black:                 #000 !default;
